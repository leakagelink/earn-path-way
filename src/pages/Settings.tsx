...
const settingsItems = [
  ...
  { icon: MessageCircle, label: "Join Telegram", to: "#", color: "text-accent", bg: "bg-accent/10", external: true },
        ...
        <div className="space-y-2">
          {settingsItems.map((item, i) => (
            ...
            >
              <Link
                to={item.to}
                className="glass-card p-3.5 flex items-center justify-between hover:border-primary/30 transition-colors"
              >
