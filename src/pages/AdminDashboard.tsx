...
const adminStats = [
  { label: "Total Users", value: "1,245", icon: Users, color: "text-info", bg: "bg-info/10" },
  { label: "Total Deposits", value: "₹4.2L", icon: ArrowDownLeft, color: "text-success", bg: "bg-success/10" },
  { label: "Total Withdrawals", value: "₹2.1L", icon: ArrowUpRight, color: "text-warning", bg: "bg-warning/10" },
  { label: "Total Earnings", value: "₹89K", icon: TrendingUp, color: "text-primary", bg: "bg-primary/10" },
];
